...
import { Candidatura, CandidaturaRequest } from '../../models/candidatura.model';
...
export class CandidaturaService {
  ...
  candidatar(vagaId: number, request: CandidaturaRequest): Observable<Candidatura> {
    return this.http.post<Candidatura>(`${this.baseUrl}/vagas/${vagaId}/candidaturas`, request);
  }
